...
const OnlineAcademySection = () => {
  return (
    <section className="bg-black text-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-4xl font-bold mb-12">
          Explore os recursos que transformam sua experiência de treino online.
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-xl font-semibold mb-4">
              Treinos personalizados para atender às suas necessidades e objetivos
              específicos.
            </h3>
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-400 mb-6">
              Receba orientações de nutricionistas para uma alimentação
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-400 mb-6">
              Visualize seu desempenho e faça ajustes para melhorar
              continuamente.
            </p>
            <a href="#" className="text-white hover:text-gray-300 flex items-center">
              Saiba Mais
...
export default OnlineAcademySection;