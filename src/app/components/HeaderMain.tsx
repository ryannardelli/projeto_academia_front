...
function HeaderMain() {
  return(
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 w-full max-w-screen-xl mx-auto">
        <a href="#" className="max-sm:hidden"><img src="assets/img/logo.png" alt="logo" className="w-36" />
        </a>
        <a href="#" className="hidden max-sm:block"><img src="assets/img/logo.png" alt="logo" className="w-36" />
        </a>
