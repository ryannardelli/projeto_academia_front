...
const Testimonial = () => {
  ...
  return (
    <>
      <section className="pb-20 pt-20 dark:bg-dark lg:pb-[120px] lg:pt-[120px] bg-neutral-900 text-white">
        <div className="container mx-auto">
          ...
          >
            <SwiperSlide>
              <SingleTestimonial
                image="https://img.freepik.com/fotos-gratis/pessoa-atletica-a-exercitar-se_23-2150989979.jpg?t=st=1706996261~exp=1706996861~hmac=e19a1fb5b19c609c3350ec1ea7917c9875b400aa552009a5ede6d56fb8983630"
                reviewImg="assets/img/logo.png"
                reviewAlt="Logo"
                 details="Desde que comecei a usar a plataforma, meus treinos ficaram muito mais organizados. As videoaulas e o acompanhamento fizeram toda a diferença!"
                name="Carlos Henrique"
                position="Aluno e assinante Pro"
              />
            </SwiperSlide>

            <SwiperSlide>
              <SingleTestimonial
                image="https://img.freepik.com/fotos-gratis/pessoa-atletica-a-exercitar-se_23-2150989997.jpg?t=st=1705508905~exp=1705509505~hmac=a9129cfe6d39e70507a59a939633cce7e000185dcecf21815c8423cb93301507"
                reviewImg="assets/img/logo.png"
                reviewAlt="Logo"
                details="A flexibilidade de treinar onde e quando quiser mudou minha rotina! O suporte dos treinadores online é excelente. Super recomendo!"
                name="Juliana Souza"
                position="Aluna e praticante de funcional"
              />
            </SwiperSlide>

             <SwiperSlide>
              <SingleTestimonial
                  image="https://blog.ciaathletica.com.br/wp-content/uploads/2017/04/capa-1-1.jpg"
                  reviewImg="assets/img/logo.png"
                  reviewAlt="logo"
                  details="Com os treinos online, consegui me organizar melhor entre o trabalho e a vida pessoal. Já eliminei 5kg em dois meses com o acompanhamento!"
                  name="Ana Clara"
                  position="Usuária Premium"
                />
             ...
             <SwiperSlide>
              <SingleTestimonial
                  image="https://media.istockphoto.com/photos/just-a-minute-to-rest-man-athletic-appearance-holds-bottle-with-water-picture-id1306137529?k=20&m=1306137529&s=612x612&w=0&h=krFSGQT7uaNhy36quE3SAGls_g8NSUR2vuXORY6jwU8="
                  reviewImg="assets/img/logo.png"
                  reviewAlt="logo"
                  details="Nunca pensei que conseguiria manter uma rotina de treinos em casa. A plataforma é prática, motivadora e os planos são fáceis de seguir!"
                  name="Marcos Lima"
                  position="Assinante e pai de dois filhos"
                />

            </SwiperSlide>
            <div className="absolute left-0 right-0 z-10 flex items-center justify-center gap-5 sm:bottom-0">
              <div className="prev-arrow cursor-pointer" onClick={handlePrev}>
                <button className="d flex h-[60px] w-[60px] items-center justify-center rounded-full border border-stroke bg-black text-dark transition-all hover:border-transparent hover:drop-shadow-testimonial dark:border-dark-3 dark:bg-dark-2 dark:text-white dark:hover:drop-shadow-none">
                  <svg
                    width="20"
                    height="21"
                    viewBox="0 0 20 21"
      ...
      <div className="relative w-full pb-16 md:w-11/12 lg:w-10/12 xl:w-8/12">
        <div className="w-full items-center md:flex">
          ...
          <div className="w-full">
            <div>
              <div className="mb-7">
                <img src={reviewImg} alt={reviewAlt} className="w-40" />
              </div>
